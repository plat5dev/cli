...
`plat5_version` (default `v0.1.6`) pins runtime GHCR tags. With Auth enabled, `auth.version` / `AUTH_VERSION` (default `v0.1.5`) pins `ghcr.io/plat5dev/auth` independently.
